...
Inspect retrieval behavior for a tenant query without sending a user message or generating an answer.

```
POST /tenants/{tenant_id}/retrieval/debug
```
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| query | string | Yes | Query to inspect |
| options | object | No | Optional retrieval overrides for this debug request |
  ...
  "data": {
    "debug": {
      ...
      "winning_faq": {
        ...
        "faq_eligible": true,
        "debug_reason": "FAQ fast lane hit: score 0.8900 >= threshold 0.7000"
      },
      "faq_candidates": [],
      "document_candidates": [
        {
...
- inspect query variants generated by retrieval
