  ...
  en: {
    translation: {
      ...
      telegram: {
        ...
        step1: '1. Create a bot using @BotFather on Telegram',
        step2: '2. Copy the bot token provided by BotFather',
        step3: '3. Paste the token above and click "Set Bot Token"',
        step4: '4. Register the webhook with Telegram using the command below',
      },
      // Admin
      admin: {
        title: 'Admin Panel',
  ...
  ar: {
    translation: {
      ...
      telegram: {
        ...
        step1: '1. قم بإنشاء بوت باستخدام @BotFather على تيليجرام',
        step2: '2. انسخ رمز البوت الذي يقدمه BotFather',
        step3: '3. الصق الرمز أعلاه وانقر على "تعيين رمز البوت"',
        step4: '4. سجل الويب هوك مع تيليجرام باستخدام الأمر أدناه',
      },
      // Admin
      admin: {
        title: 'لوحة المسؤول',
