            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <ArrowRight size={16} className="text-glass-textSecondary group-hover:text-white group-hover:translate-x-1 transition-all arrow-card-rtl rtl-flip" />
                </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            >
              ...
              <ArrowRight size={14} className="opacity-0 group-hover:opacity-100 translate-x-1 group-hover:translate-x-0 transition-all arrow-slide-rtl rtl-flip" />
            </button>
          </div>
              ...
              >
                ...
                <div className="pt-3 mt-3 border-t border-white/10">
                  <button className="w-full glass-button-secondary py-2 rounded-lg text-xs font-medium flex items-center justify-center gap-1.5 group">
                    ...
                    <ArrowRight size={12} className="opacity-0 group-hover:opacity-100 translate-x-1 group-hover:translate-x-0 transition-all arrow-slide-rtl rtl-flip" />
                  </button>
                </div>
              </div>
            ))}
